...
neg_words = set(line.strip() for line in open('negative-words.txt',encoding="ISO-8859-1"))
pos_words = set(line.strip() for line in open('positive-words.txt',encoding="ISO-8859-1"))
...
def mean_accuracy_per_setting(results):
    ...
    print("possible feats", possibleFeats)

                 
# =============================================================================
#     for feat in possibleFeats:
#         for result in results:
#             print(" feat", possibleFeats)
#             if result['features'] == feat:
#                 num[feat] += result['accuracy']
#                 den[feat] += 1
#                 
#         for freq in possibleFreqs:
#             if result['min_freq'] == freq:
#                 num[freq] += result['accuracy']
#                 den[freq] += 1
#     
#     for p in possiblePunct:
#         for result in results:
#             if result['punct'] == p:
#                 if p == True:
#                     num['True']+= result['accuracy']
#                     den['True']+=1  
#                 elif p == False:
#                     num['False']+= result['accuracy']
#                     den['False']+=1 
# =============================================================================
...
#               acc = num[str(setting)]/den[str(setting)]
#           else:
# =============================================================================
